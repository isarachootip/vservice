...
import { ShieldCheck, ShieldX, Wrench, FileText, ArrowRight, Eye, ClipboardList } from "lucide-react";
    ...
    return (
        <section className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-1.5 text-xs text-slate-400 font-semibold">
                ...
                <span>ส่งซ่อม</span>
                <span>/</span>
                <span className="text-[#c8102e]">ส่งมอบให้ GR</span>
            </div>
            ...
            <div className="flex flex-col gap-1">
                <h1 className="text-xl md:text-2xl font-black text-slate-800 flex items-center gap-2">
                    ...
                    บันทึกรายละเอียดการส่งมอบให้ GR (CS to GR)
                </h1>
                <p className="text-xs text-slate-400 font-medium pl-3.5">
                    บันทึกการส่งมอบเครื่องซ่อมจากแผนกบริการลูกค้า (CS) ไปยังคลังสินค้าสาขา (GR)
                </p>
            </div>
            ...
            <div className="bg-white border border-slate-200/80 border-t-4 border-t-[#c8102e] rounded-2xl p-6 md:p-8 shadow-sm">
                <form className="space-y-8">
                    ...
                    {/* Section 3: Delivery to GR */}
                    <div>
                        <div className="flex items-center gap-2 pb-2.5 border-b border-slate-100 mb-6">
                            <span className="w-1 h-4 bg-[#c8102e] rounded-full inline-block"></span>
                            <h3 className="text-sm font-bold text-slate-800">
                                🚚 บันทึกข้อมูลการส่งมอบให้ GR
                            </h3>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="senderName" className="block text-xs font-bold text-slate-700 mb-1.5">ผู้ส่งมอบ<Req /></label>
                                <input
                                    id="senderName"
                                ...
                                />
                                {errors.senderName && <p className="text-red-600 text-[10px] font-bold mt-1">{errors.senderName}</p>}
                            </div>
                            <div>
                                <label htmlFor="receiverName" className="block text-xs font-bold text-slate-700 mb-1.5">ผู้รับสินค้า (เจ้าหน้าที่ GR)<Req /></label>
                                <input
                                    id="receiverName"
                            ...
                            <div>
                                <label htmlFor="sendDate" className="block text-xs font-bold text-slate-700 mb-1.5">วันที่ส่งมอบสินค้า<Req /></label>
                                <DatePicker
                                    id="sendDate"
                                    selected={sendDate}
                            ...
                            <div>
                                <label htmlFor="receiverTel" className="block text-xs font-bold text-slate-700 mb-1.5">เบอร์ติดต่อผู้รับมอบ<Req /></label>
                                <input
                                    id="receiverTel"
                    ...
                    <div>
                        <div className="flex items-center justify-between pb-2.5 border-b border-slate-100 mb-6">
                            <div className="flex items-center gap-2">
                                <span className="w-1 h-4 bg-[#c8102e] rounded-full inline-block"></span>
                                <h3 className="text-sm font-bold text-slate-800">
                                    📷 ถ่ายภาพประกอบการส่งมอบสินค้า (Attachments)
                                </h3>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            {renderUploadSlot('slot4', 'เอกสารใบส่งมอบ/Serial Tag*', true, fileSlot4, previewSlot4, setFileSlot4, slot4Ref)}
                        </div>
                        {errors.attachments && (
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 flex items-center justify-between shadow-xl">
                ...
                <div className="flex items-center gap-2">
                    <span className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider hidden md:inline-block">ขั้นตอนปัจจุบัน: CS to GR</span>
                    <button
                        type="button"
                        onClick={onSave}
                    ...
                    >
                        บันทึกและส่งมอบต่อ <ArrowRight className="w-3.5 h-3.5" />
                    </button>
                </div>
            </div>
